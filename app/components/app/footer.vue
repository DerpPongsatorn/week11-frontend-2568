<template>
  <footer class="font-[Sarabun] bg-[#6b0892] py-6 px-8 mt-4 tracking-wide">
    <div class="relative max-w-screen-xl mx-auto">
      <div class="bg-[#ffffff] rounded-b-lg gap-3 rounded-md shadow-2xl flex flex-wrap items-center justify-between sm:px-8 max-sm:px-4 py-5 absolute top-[-66px] w-full"> 
        ...
        <button type="button" class="px-4 py-2 text-[15px] font-semibold text-white bg-[#6b0892] rounded-full gap-2 cursor-pointer">
          สํานักงานคณะกรรมการการอาชีวศึกษา
        </button>
      </div>

      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 pt-15 px-4 rounded-b-md bg-[#6b0892]">
     ...
     <div class="bg-[#6b0892] pt-5 sm:px-30 w-full">
